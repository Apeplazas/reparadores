...
$.fn.editInPlace.defaults = {
	...
	bg_out:				"", // string: background color on restore from hover
	...
	textarea_rows:		6, // integer: set rows attribute of textarea, if field_type is set to textarea. Use CSS if possible though
